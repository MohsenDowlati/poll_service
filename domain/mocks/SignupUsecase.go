...
// GetUserByPhone provides a mock function with given fields: c, phone
func (_m *SignupUsecase) GetUserByPhone(c context.Context, phone string) (domain.User, error) {
